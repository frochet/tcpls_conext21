...
\begin{abstract}
  ...
  This paper revisits this assumption and demonstrates the various benefits a 
  closer integration between \tcp and \tls brings.
  \todo{François}
...
%  more adapted for several connection migration scenarios.
  ...
  application\todo{This a matter of impl. not protocol}, can be easily deployed 
