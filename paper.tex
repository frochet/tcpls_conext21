...
\begin{abstract}
  ...
  Following the layered model of the Internet, %\tls was designed to be as 
  %independent as possible from the underlying transport protocol.
...
%  more adapted for several connection migration scenarios.
  ...
  \tcpls implementation demonstrate that it offers higher performance than 
