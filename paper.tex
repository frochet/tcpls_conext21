...
%  more adapted for several connection migration scenarios.
  ...
  application and can be easily deployed as an extension to user-space \tls libraries,  while being implemented at a low cost. Measurements demonstrate that it offers higher performance than existing \quic libraries with a super set of transport services.
\end{abstract}
