...
\begin{abstract}
  ...
  This paper introduces \tcpls, a modern and secure transport that is
  wire-compatible with \tcp and thus transparent for middleboxes. It leverages
  ...
  provides higher performance than existing \quic libraries with similar
  protocol features.
