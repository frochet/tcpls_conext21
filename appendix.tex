...
\node[text width=10mm] at (3.2,11.55) {$72.18ms$};
\node[text width=10mm] at (-3.4,11.55) {$51.95ms$};
\node[text width=10mm] at (3.2,10.80) {$72.87ms$};
\node[text width=10mm] at (-3.4,10.80) {$96.17ms$};

\node[text width=10mm] at (3.2,10.2) {$73.06ms$};
\node[text width=10mm] at (-3.4,10.2) {$96.72ms$};

\node[text width=10mm] at (3.2,9.7) {$73.18ms$};
\node[text width=10mm] at (-3.4,9.7) {$96.86ms$};

\node[text width=10mm] at (3.2,9.1) {$75.85ms$};
\node[text width=10mm] at (-3.4,9.1) {$96.92ms$};

\node[text width=10mm] at (3.2,8.4) {$117.27ms$};
\node[text width=10mm] at (-3.4,8.4) {$97.07ms$};

\node[text width=10mm] at (3.2,7.8) {$117.63ms$};
\node[text width=10mm] at (-3.4,7.8) {$137.91ms$};

\node[text width=10mm] at (3.2,7.1) {$117.71ms$};
\node[text width=10mm] at (-3.4,7.1) {$139.12ms$};

\node[text width=10mm] at (3.2,6.5) {$117.96ms$};
\node[text width=10mm] at (-3.4,6.5) {$178.22ms$};

\node[text width=10mm] at (3.2,4.6) {$268.93ms$};
\node[text width=10mm] at (-3.6,4.6) {$289.05ms$};

\node[text width=10mm] at (3.2,3.3) {$13358.268ms$};
\node[text width=10mm] at (-3.6,3.3) {$13398.892ms$};

\node[text width=10mm] at (3.2,2.7) {$13358.453ms$};

\node[text width=10mm] at (3.2,2.1) {$13358.516ms$};
\node[text width=10mm] at (-3.6,2.1) {$13439.685ms$};

\node[text width=10mm] at (3.2,1.5) {$13358.621ms$};


%\node[text width=10mm] at (3.2,-0.8) {$15991.13ms$};
%\node[text width=10mm] at (-3.6,-0.8) {$15870.75ms$};

\node[text width=10mm] at (3.2,0.9) {$13399.144ms$};

\node[text width=10mm] at (3.2,0.3) {$13399.238ms$};

%\node[text width=10mm] at (3.2,-1.5) {$15891.35ms$};
%\node[text width=10mm] at (-3.6,-1.5) {$15911.63ms$};

\node[text width=10mm] at (-3.6,-0.4) {$13439.787ms$};

\node[text width=10mm] at (-3.6,-1.0) {$13439.829ms$};
...
\node[text width=10mm] at (-3.6,-1.6) {$13439.940ms$};

\node[text width=10mm] at (-3.6,-2.2) {$13439.980ms$};

\node[text width=10mm] at (-3.6,-3.5) {$13481.659ms$};

\node[text width=10mm] at (3.2,-4.9) {$15070.751ms$};

\node[text width=10mm] at (3.2,-5.5) {$15070.836ms$};

\node[text width=10mm] at (3.2,-6.1) {$15070.862ms$};

\node[text width=10mm] at (-3.6,-4.2) {$13520.552ms$};



\node[text width=10mm] at (-3.6,-9.2) {$15777.726ms$};
\node[text width=10mm] at (3.2,-8.7) {$15091.967ms$};

\node[text width=10mm] at (-3.6,-11.2) {$21026.605ms$};
\node[text width=10mm] at (3.2,-11.2) {$19662.913ms$};

\node[text width=10mm] at (-3.6,-11.8) {$21026.669ms$};
\node[text width=10mm] at (3.2,-11.8) {$20987.919ms$};
...
\filldraw[fill=red!20]
  ...
  (\Server 33.north west) rectangle (\Server 33.south east)
  (\Client 34.north west) rectangle (\Client 34.south east)
  (\Server 37.north west) rectangle (\Server 37.south east)
  (\Client 37.north west) rectangle (\Client 37.south east)
  (\Server 38.north west) rectangle (\Server 38.south east)
  (\Client 38.north west) rectangle (\Client 38.south east)
  ;
