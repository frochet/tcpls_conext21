...
\paragraph*{3) More Flexible Connection Migration}
...
(depending on the date left in \tcp's sending buffer and the path bandwidth and
...
re-establish the connection. However, if the failover feature is not enabled and
