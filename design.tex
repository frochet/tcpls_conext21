...
single
application object can use \tcpls \textit{coupled streams}. \todo{This
abstraction could be surprising if we didn't mention yet that streams cannot be
put on more than one connection.} When coupling
