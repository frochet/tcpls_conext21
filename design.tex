...
Compared to \mptcp, \tcpls achieves a secure Join mechanism in which
...
the same \tcpls session. The \tcpls initial handshake and the Join mechanism can
be enhanced to support this goal, offering encrypted tokens in the initial
handshake. One could then spent these tokens for each Join handshake,
effectively acting as both a session identifier and a cookie. Further more
tokens could be generated and shared upon successful Joins.
