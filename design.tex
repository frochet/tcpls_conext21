...
record's implicit sequence number encoded in 64 bits. XORing the lower 64 bits
...
design implies that we give the underlying cipher the 32 upper bits
...
i.e, 1024 times 128 bits, with 128 bits the minimum AEAD block
