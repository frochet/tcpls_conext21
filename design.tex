...
receiver to distinguish several streams multiplexed to the same \tcp connection.
Indeed, when different streams are carried
over the same \tcp connection, \tcpls does not explicitely know which
cryptographic context decrypts properly the record. We argue that this is not an
...
experimented with \tls records that include the Stream ID in the associated data
