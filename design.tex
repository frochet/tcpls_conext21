...
which lead to at least 25 bits to encode a unique stream number. Encoding such
...
maintains AEAS's core assumption (uniqueness of nonce), which means that the
