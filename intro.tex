...
extensibility. Indeed, the integration of \tls 1.3 allows 1-RTT secure 
...
\begin{itemize}
	...
	combined to improve extensibility?
  ...
  \item[{\small{\textit{RQ2}}} -] How can we alleviate middlebox
    interferences?
	\item[{\small{\textit{RQ3}}} -] What are the new transport services this combination can offer?
