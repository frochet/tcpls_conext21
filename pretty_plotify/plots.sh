...
python3 plot_perf.py --trace $input/mvfst_default_mtu.log $input/mvfst_gso_default_mtu.log $input/mvfst_jumbo_pmtu1460.log $input/msquic_default_mtu.log $input/msquic_jumbo_aes128gcmsha256.log $input/quicly_default_mtu.log $input/quicly_gso_default_mtu.log $input/quicly_jumbo_pmtu1460.log $input/tls_default_mtu_aes128gcmsha256.log $input/tcpls_default_mtu_aes128gcmsha256.log $input/tls_jumbo_aes128gcmsha256.log $input/tcpls_jumbo_aes128gcmsha256.log $input/tcpls_mtu1500_failoveron_aes128gcmsha256.log $input/tcpls_jumbo_failoveron_aes128gcmsha256.log --label  "mvfst pacing on" "mvfst pacing on, gso on" "mvfst pacing on, gso on/mtu 9000" "Msquic" "Msquic mtu 9000" "Quicly" "Quicly - gso on" "Quicly gso on, mtu 9000" "TLS/TCP tso on" "TCPLS tso on" "TLS/TCP tso on, mtu 9000"  "TCPLS tso on, mtu 9000" "TCPLS tso on, failover on" "TCPLS tso on, failover on, mtu 9000" --oname $output/perf_analysis --ext $1
