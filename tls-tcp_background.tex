...
\tls 1.3 \cite{rfc8446} brings several essential features compared to the previous versions. It
...
leverages \tls 1.3 \cite{rfc8446} and negotiate the security keys and authenticate
