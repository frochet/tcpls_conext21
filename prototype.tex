...
($v$, \textit{Sec. \ref{sec:prot-ebpf}}) The server can securely inject eBPF 
...
\subsection{Congestion controller remote injection}
\label{sec:prot-ebpf}
...
version 5.6, an application can inject congestion control schemes 
...
to inject a new eBPF congestion controller to the client over the \tcpls 
session.
