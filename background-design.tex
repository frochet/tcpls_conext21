...
\begin{tikzpicture}[node distance=0 cm,outer sep = 0pt,inner sep = 2pt, scale=0.80, transform shape]
        ...
        \tikzset{tcpls/.style={align=center,shape=rectangle,fill=green!70!red!100,minimum height=0.7cm,minimum width=22mm,rounded corners, draw}}
        \tikzset{api/.style={align=center,shape=rectangle,fill=purple!30,minimum height=0.7cm,minimum width=22mm,rounded corners,draw}}
        \tikzset{tcp/.style={align=center,shape=rectangle,fill=yellow, minimum height=0.5cm,minimum width=5mm,rounded corners,draw}}
        \tikzset{label/.style={align=center,minimum height=0.5cm,minimum width=5mm}}
        \draw(-3,-0.3) rectangle (-0.5,0.3);
        \draw(-3,-3.2) rectangle (-0.5,0.3);
        \draw [red, ultra thick] (-3,-2) -- (-0.5,-2);
        \draw(-3,-4) rectangle (-0.5,-3.2);
        ...
        \node[tcpls, below= 0mm and 0mm of api1](tcpls1){TCPLS};
        \node[tcp, below= 3mm and 0mm of tcpls1, xshift=-6mm](tcpx1){TCPx};
        \node[tcp, right=5mm and 0mm of tcpx1, yshift=-4mm, xshift=2mm](tcpy1){TCPy};
        \node[label,  below=7mm and 0mm of tcpx1](ip11){IPV4};
        \node[label,  below=4mm and 0mm of tcpy1](ip12){IPV6};
        
        
        \draw(2.3,-0.2) rectangle (4.8,0.4);
        \draw(2.3,-3.2) rectangle (4.8,0.4);
        \draw [red, ultra thick] (2.3,-2) -- (4.8,-2);
        \draw(2.3,-4) rectangle (4.8,-3.2);
        ...
        \node[tcpls, name=TCPLS, below=of api2](tcpls2){TCPLS};
        \node[tcp, below= 3mm and 0mm of tcpls2, xshift=-6mm](tcpx2){TCPx};
        \node[tcp, right=5mm and 0mm of tcpx2, yshift=-4mm, xshift=2.3mm](tcpy2){TCPy};
        \node[label,  below=7mm and 0mm of tcpx2](ip21){IPV4};
        \node[label,  below=4mm and 0mm of tcpy2](ip22){IPV6};
        
        \node[label,  below=5mm and 0mm of application2, xshift=15mm,rotate=90 ](user1){user space};
        \node[label,  below=28mm and 0mm of application2, xshift=15mm, rotate=90 ](user1){kernel space};
        
        \node[label,  left=of api2, xshift=-5mm, yshift=-5mm, green!70!red!100 ](user1){TLS records};
        \node[label,  left=of ip22, xshift=-18mm, yshift=11mm ](user1){TCP segments};
