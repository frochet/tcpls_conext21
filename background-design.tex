...
records, we can supplement the \tls-encrypted application data with
...
conveyed in new \tls records. We answer {\small{\textit{RQ2}}} by proposing a
design wire-indistinguishable from
TLS 1.3 \texttt{AppData} records, leading to middlebox compatibility. %and new transport services can be built
...
clients. \todo{Il manque l'explication sur la clôture de la session. Est ce à cause d'un problème d'espace?}
