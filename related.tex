...
Given its security features, \tcpls must be compared with \tcpcrypt \cite{bittau2010case,rfc8548}. \tcpcrypt predates \tls 1.3. It uses TCP options to support opportunistic encryption. \tcpls is compatible with \tls and supports additional feature. It is also compatible with \tcp middleboxes.
...
TLS \cite{sy2020enhanced} \todo{FR}
