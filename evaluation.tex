...
provides the goodput as measured in our testbed. We report both the bandwidth in
...
bottom bar (labeled ``\tcpls tso on mtu 9000'') is the highest median goodput
...
The next bar (labeled ``\tcpls tso on'') shows that with TSO and standard frame size (1,500 bytes MTU), the goodput still reaches 10.84 Gbps. These
...
\tcpls can reach a goodput of 8.8 Gbps, i.e. less than 10\% below the
