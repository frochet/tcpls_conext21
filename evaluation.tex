...
\tcpls was configured to use the AES-GCM with 128 bits block size and the hash
function SHA256.  Fig.~\ref{fig:perf} provides the goodput measured in our
...
AES-GCM peaks at 13,1 Gbps when doing in-memory encrytion/decryption on our
testbed's servers.
...
\begin{figure}[!t] \begin{center}
  ...
  \caption{The \tcpls prototype is faster than \tls over \tcp and different
    \quic implementations.} \label{fig:perf} \end{figure}
