...
This impact could be reduced by reducing the number of record acknowledgments,
which should also improve the throughput under larger MTU. We 
...
Both have two major differences. First, for MPTCP, there is a delay before it becomes fully utilized. 
...
chosen by the application to reflect specific use cases.
