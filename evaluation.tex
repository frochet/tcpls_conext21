...
finally inform \mptcp~\cite{paasch2012exploring} \todo{Est ce qu'il n'en est pas de même pour \tcpls indirectement?}.
...
option, which is set to $250~ms$ in our experiment \todo{why $250~ms$?? small justification is needed}.
%(mp): (should) already been explained in Section prototype
